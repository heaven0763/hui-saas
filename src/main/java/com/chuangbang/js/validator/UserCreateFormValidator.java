package com.chuangbang.js.validator;
...
import com.chuangbang.js.vo.UserCreateForm;
...
public class UserCreateFormValidator implements Validator {
	...
	private void validateMobile(Errors errors, UserCreateForm form) {
		if (userService.findUserByMobile(form.getMobile()) != null) {
			errors.reject("username.exists",
