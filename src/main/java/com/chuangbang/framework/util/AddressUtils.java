...
public class AddressUtils {
	public static void main(String[] args) {  
	 ...
	 public static String getCity(String ip) throws Exception{
         ...
         try {  
        	 ...
        	 JSONObject json = AddressUtils.getAddressObj("ip="+ip, "utf-8"); 
        	   if(json != null){  
                   if("0".equals(json.get("code").toString())){  
                	   return AddressUtils.decodeUnicode(json.optJSONObject("data").getString("city"));
                   }else{  
                       return null;  
                   }  
               }else{
     ...
     * @throws Exception 
     */  
    public static JSONObject getAddressObj(String params, String encoding) throws Exception{  
        ...
        if(returnStr != null){  
            ...
            if("0".equals(json.get("code").toString())){  
                ...
                StringBuffer buffer = new StringBuffer();  
                 System.out.println(json.optJSONObject("data").toString());
