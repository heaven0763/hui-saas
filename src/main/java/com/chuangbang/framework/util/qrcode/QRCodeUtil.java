package com.chuangbang.framework.util.qrcode;
...
public class QRCodeUtil {  
    ...
    public static void main(String[] args) throws Exception {  
        String text = "官方官方公告很给力合计合计";  
        String qrcode = System.getProperty(Constant.WORKDIR)+"static/shop/qrcode/";
        String filename = text+".jpg";
        QRCodeUtil.encode(text, "d:/aaa/",filename, true);  
