...
public class PdfHelper {
    ...
    public static ITextRenderer getRender() throws DocumentException, IOException {
        ...
        ITextRenderer render = new ITextRenderer(2.2f,1);
 
        String path = getTplPath();
        //添加字体，以支持中文
        render.getFontResolver().addFont(path + "font/msyh.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
    ...
    public static String getPath(){
        return PdfHelper.class.getClass().getResource("/").getPath().substring(1);
    }
    ...
    public static String getTplPath(){
    	String tplPath =System.getProperty("user.dir").replace("bin", "webapps")+"/hui/static/pdf/";//"J:/workspace/hui/src/main/webapp/static/pdf/";//
        return tplPath;// PdfHelper.class.getClass().getResource("/").getPath().substring(1); //tplPath;//System.getProperty("user.dir") +
    }
 
    
    public static void main(String[] args) {
		System.out.println( getTplPath());
	}
}