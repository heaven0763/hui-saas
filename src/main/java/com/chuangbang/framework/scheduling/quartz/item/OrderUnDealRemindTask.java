...
public class OrderUnDealRemindTask implements Job{
	
	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("----------OrderUnDealRemindTask---execute----" + new Date().getTime());
		CommonBussinessService commonBussinessService = (CommonBussinessService) SpringUtils.getBean("commonBussinessService");
		commonBussinessService.cancelUnDealOrder();
	}
