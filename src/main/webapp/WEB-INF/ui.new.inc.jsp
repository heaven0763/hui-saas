...
<script src="${staticPath}/public/hplus/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${staticPath}/public/hplus/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="${staticPath}/public/hplus/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="${staticPath}/public/hplus/js/plugins/sparkline/jquery.sparkline.min.js"></script>
...
<script src="${staticPath}/public/hplus/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
...
<!-- timeLines -->
<%-- <link rel="stylesheet" href="${staticPath}/public/timeLines/css/reset.css"> <!-- CSS reset -->
<link rel="stylesheet" href="${staticPath}/public/timeLines/css/style.css"> <!-- Resource style -->
<script src="${staticPath}/public/timeLines/js/modernizr.js"></script> <!-- Modernizr -->
<script src="${staticPath}/public/timeLines/js/jquery.mobile.custom.min.js"></script>
<script src="${staticPath}/public/timeLines/js/main.js"></script> --%>
<!-- timeLines end -->
