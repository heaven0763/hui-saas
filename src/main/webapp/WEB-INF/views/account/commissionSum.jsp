...
$(function(){
	...
	$("#commissionSum_table").bootstrapTable();
	
});
function commissionSum_queryParams(params){
	return $.extend({},params,util.serializeObject($('#commissionSum_searchForm')));
}
function commissionSum_search(){
	$("#commissionSum_table").bootstrapTable("refresh");
}
...
<form class="form-inline" id="commissionSum_searchForm">
	  <div class="form-group">
			...
			<label for="state">返佣状态</label>
		  	...
		  	<button type="button" class="btn btn-primary" onclick="commissionSum_search()"><span class="glyphicon glyphicon-search"> </span> 查询</button>
	 	</div>
</form>
<br>
<table id="commissionSum_table" class="table-condensed" data-toggle="table" data-height="560" data-query-params="commissionSum_queryParams"
		data-pagination="false" data-url="${ctx}/base/order/commissionSum/list" data-data-type="json" >
	    <thead>
	        <tr>
				<th data-field="hotelName">场地名称</th>
				<th data-field="totalCommissionOrder" style="word-break:break-all; word-wrap:break-all;">返佣订单数</th>
				<th data-field="totalOrderMoney" style="word-break:break-all; word-wrap:break-all;">订单金额</th>
				<th data-field="totalCommissionAmount" style="word-break:break-all; word-wrap:break-all;">返佣金额</th>
	        </tr>
	    </thead>
	</table>
</div>
