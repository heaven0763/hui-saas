...
<body class="">
	...
	<div id="top_toolbar" class="toolbar" style="">
		<div class="toolbar-title">
			...
			<div class="toolbar-one" style="">
				<span class="toolbar-one-text" style="">状态</span><i class="fa fa-angle-down toolbar-one-arrow" style="">&nbsp;</i>
			</div>
		</div>
	</div>
	...
	<form id="form_list_params" style="display:none;">
		...
		<input id="search_EQ_hotelSaleMobile" type="text" name="search_EQ_o.contact_number" />
		...
		<input id="search_state" type="text" name="search_EQ_o.commission_status"  /> 
		...
		<input id="" type="text" name="search_OR_EQ;o.state" value="021,04,06,07" /> 
	</form>
</body>
...
$(function(){
	...
	pager = new common.customPage({
		startnow : false,
		url :  '${ctx}/weixin/order/commission/list',
...
{{each rows as item i}}
<div class="one-list" style="" item-rdurl="${ctx}/weixin/order/reconciliation/detail/{{item.id}}">
	<div class="one-list-ct-title" style="">
