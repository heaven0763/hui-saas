...
<body class="">
	...
	<div id="top_toolbar" class="toolbar" style="text-align:center;">
...
$(function(){
	...
	var pager = new common.customPage({
		startnow : true,
		url :  '${ctx}/base/hotel/record/recordList',
...
<div class="one-list" style="">
	...
	<div class="font-size-min" style="margin-top:0.5rem;">
		<div style="float:left;">状态：
			...
			{{else if item.state==2}}
				<span class="label label-default">已撤回申请</span>
	...
	<div class="one-list-ct-sett" style="margin-top:0.5rem;">
		{{if item.state==0 }}
			<input class="btn btn-xs bg-type-01" type="button" style="float:right;min-width:4.2rem;margin 0 auto;" id="cancle" onclick="cancle({{item.hotelId}})" value="撤回"/>
		{{/if}}
	</div>
	<div style="clear:both;"></div>
</div>
