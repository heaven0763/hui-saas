	...
	common.ajaxjson({
		...
		success : function(res){
			...
			for(var i in permissons){
				...
				html.push('<div class="btn btn-xs pms-item bg-none-01" pmsid="'+permissons[i].permissionId + '" has="1" style="padding:0.2rem 0;width:48%;">'+permissons[i].permissionName+'</div>');
			...
			for(var i in allPermissions){
				...
				html.push('<div class="btn btn-xs pms-item btn-disable" pmsid="'+allPermissions[i].id + '" has="0" style="padding:0.2rem 0;width:48%;">'+allPermissions[i].displayname+'</div>');
			}
