...
<body class="">
	<div style="height:1.6rem;width:95%;margin:0 auto;margin-top:1rem;">
		<input id="input_search_val" type="text" name="" value="" style="width:72%;background-color:#f5f3f4;border:none;height:100%;outline:none;padding:0 4%;" placeholder="搜索场地名称" />
	...
	<form id="form_list_params" style="display:none;">
		<input type="hidden" name="search_EQ_clientType" value="HOTEL">
