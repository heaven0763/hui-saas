...
$(document).ready(function() {
	$(".tcchsbj").height($(window).height());
	$(".tcchsbj").width($(window).width());
	$(".tcchsbj").click(function() {
		$(".tcchsbj").hide();
		$(".grdpxqtcf").hide();
		$(".grdpxqtcf2").hide();
	});
	$(".tcyddq").click(function() {
		$(".tcchsbj").show();
		$(".grdpxqtcf").show();
	});
	$(".grdpxqtcf .grdpxqanz div").click(function() {
		$(".tcchsbj").hide();
		$(".grdpxqtcf").hide();
	});
	$(".grdpxqtcf .grdpxqanz input").click(function() {
		$(".grdpxqtcf").hide();
		$(".grdpxqtcf2").show();
	});
});
