...
//获取某个月最后一天的日期对象,月份和星期是从0开始
function getTheLastDateOfLastMonth(date){
	var dt = date || new Date();  
    dt.setDate(1);  //1表示某年某月的第一天
    dt.setMonth(dt.getMonth() + 1);  
    cdt = new Date(dt.getTime()-1000*60*60*24);  
    // alert(cdt.getFullYear()+"年"+(Number(cdt.getMonth() + 1))+"月月末日期:"+cdt.getDate()+"日  星期" +cdt.getDay());  
    return cdt;
}
